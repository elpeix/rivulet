...
pub struct Lang {
    ...
    pub help_clear_read: String,
    pub help_reload_entries: String,
...
impl Lang {
    pub fn from_code(code: &str) -> Self {
        ...
        Self {
            ...
            copied_to_clipboard: get!(map, en, "copied_to_clipboard"),
            copy_failed: get!(map, en, "copy_failed"),
            ...
            help_toggle_bypass: get!(map, en, "help_toggle_bypass"),
            ...
            help_copy_preview: get!(map, en, "help_copy_preview"),
            ...
            help_clear_read: get!(map, en, "help_clear_read"),
            help_reload_entries: get!(map, en, "help_reload_entries"),
